...
网站目前包含 5 个学习板块、18 门入门课程大纲，以及已经完整展开的三门 AI 教程：《机器学习入门》16 节、《深度学习入门》14 节、《大语言模型入门》15 节，共 45 节。

## 项目结构

- `app/`：首页、AI 课程地图、课程页与全站组件。
- `lib/`：板块介绍、共享课程结构和三门完整教程的数据。
...
`npm test` 会先完成生产构建，再检查密码入口、首页、AI 课程地图、三门课程目录和关键单课页面。
